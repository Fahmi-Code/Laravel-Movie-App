<div class="relative  mt-3 md:mt-0" x-data="{ isOpen: true }" @click.away="isOpen=false">
    <input
        ...
        "
        @keydown.escape.window="isOpen=false" @focus="isOpen=true" @keydown="isOpen=true" @keydown.shift.tab="isOpen=false"
    >
            ...
            @foreach ($searchResults as $result)
                <li class="border-b border-gray-700">
                    ...
                    >
                        ...
                        @else
                         <img src="https://placehold.co/600x400/EEE/31343C" alt="poster" class="w-12">
                        @endif
